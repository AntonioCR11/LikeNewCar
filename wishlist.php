...
<body onload="hideSecondInput()">
    ...
    <div class="product py-4">
        <div class="container">
            <h1 class="content mb-4 text-center">Wishlist</h1>
            <div class="content" id="content">
                ...
                ?>
                        <form action="#" method="GET">
                            <div class="wishContainer mb-3 p-3">
                                <div class="imageContainer" style="background-image: url(./Asset/shopAsset/car_<?= $car["id_car"] ?>.jpg);"></div>
                                <div class="carInfo my-3">
                                    <div class="name">
                                        <h2 class="mb-0"><?= $car["car_brand"] ?> <?= $car["car_model"] ?><?= $car["car_name"] ?></h2>
                                    </div>
                                    <div class="price text-danger">
                                        <h4 class="m-0"><?= rupiah($car["car_price"]) ?></h4>
                                    </div>
                                ...
                                <div class="buttonContainer">
                                    <button class="w-10 btn btn-lg btn-outline-success" name="add" value="<?= $value["id_car"] ?>">+Keranjang</button>
                                </div>
                            </div>
                        </form>
                <?php
