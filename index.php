...
<head>
    ...
    <style>
        ...
        .banner2 {
            background-image: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url("./Asset/homeAsset/HeroBG2.jpg");
...
<body onload="hideSecondInput()">
    ...
    <div class="jumbotron jumbotron-fluid banner mb-0">
        <div class="container text-white">
            <div class="row h-100 mx-0">
                <div class="left col-sm-12 col-md-6 col-lg-6" style="padding-top: 17%;">
                    <!-- KIRI -->
                    <h1 style="font-size: 2.7em;font-weight:700;">INGIN JUAL BELI MOBIL BEKAS?</h1>
                    <p class="lead mt-2" style="font-size: 1.1em;">Dapatkan Harga Terbaik Melalui Sistem Penawaran Transparan </p>
                </div>
                <div class="right col-sm-12 col-md-6 col-lg-6" style="padding-top: 15%;">
                    <!-- KANAN -->
                    <form class="row g-3 needs-validation bg-dark" style="padding:35px 25px;border-radius:3%;" ; novalidate>
                        <h5>Masukkan Data Mobil Anda Untuk Cek Harga Gratis!</h5>
                        <div class="col-md-6 mt-2">
                            <label for="validationCustom01" class="form-label">Merk</label>
                            <input type="text" class="form-control" id="validationCustom01" value="Pilih Merk Mobil" required>
                        ...
                        <div class="col-md-6 mt-2">
                            ...
                            <input type="text" class="form-control" id="validationCustom02" value="Pilih Model Mobil" required>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
                        <div class="col-md-12 mt-2 mb-3">
                            <label for="validationCustom03" class="form-label">Pilih kota</label>
                            <input type="text" class="form-control" id="validationCustom03" value="Periksa kota anda" required>
    ...
    <!-- PARALAX -->
    <div class="paralax bg-dark text-white py-4">
        <div class="container">
            <div class="row text-center">
                <h2 class="mb-5">Bagaimana cara menjual?</h2>
                <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                    <img class="par1-1 me-2" src="./Asset/homeAsset/paralax1.png" alt="" width="75" height="23" class="d-inline-block align-text-top">
                    <h6>Jadwalkan inspeksi mobilmu sekarang!E</h6>
                </div>
                <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                    <img class="par1-2 me-2" src="./Asset/homeAsset/paralax1.png" alt="" width="75" height="23" class="d-inline-block align-text-top">
                    <h6>Datang ke lokasi janji inspeksi</h6>
                </div>
                <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                    <img class="par1-3 me-2" src="./Asset/homeAsset/paralax1.png" alt="" width="75" height="23" class="d-inline-block align-text-top">
                    <h6>Jual langsung kepada kami atau melalui sistem penawaran transparan</h6>
                </div>
                <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                    <img class="par1-4 me-2" src="./Asset/homeAsset/paralax1.png" alt="" width="75" height="23" class="d-inline-block align-text-top">
                    <h6>Serahkan semua urusan dokumen penjualan mobilmu kepada kami dan dapatkan pembayaran dalam 1 jam*</h6>
                </div>
            </div>
        </div>
    </div>
    <!-- BANNER 2-->
    <div class="jumbotron jumbotron-fluid banner2 mb-0">
        <div class="container text-white text-center py-5" style="display:flex;flex-direction:column;">
            <!-- KIRI -->
            <h1 style="font-size: 2.4em;font-weight:700;">Mau jual mobil?</h1>
            <!-- JUAL MOBIL -->
            <?php if (!isset($_COOKIE["activeUser"])) { ?>
                <!-- JUAL MOBIL -->
                <form action="" method="POST">
                    <button class="btn btn-warning mx-auto" style="width: 35%;font-weight:600;" name="jual">Ajukan Inspeksi Sekarang</button>
                </form>
            <?php } else { ?>
                <!-- JUAL MOBIL -->
                <button class="btn btn-warning mx-auto" style="width: 35%;font-weight:600;" onclick="topFunction()">Ajukan Inspeksi Sekarang</button>
            <?php } ?>
            <p class="lead mt-2" style="font-size: 1em;">Atau kunjungi Inspection Point kami</p>
        </div>
    </div>
    <!-- PARALAX 2 -->
    <div class="paralax bg-light py-4">
        <div class="container">
            <div class="row text-center">
                <h2 class="mb-5">Mengapa memilih kami?</h2>
                <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                    <img class="par1-1 me-2" src="./Asset/homeAsset/paralax2.png" alt="" width="75" height="23" class="d-inline-block align-text-top">
                    <h6>Pembayaran Instan</h6>
                </div>
                <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                    <img class="par1-2 me-2" src="./Asset/homeAsset/paralax2.png" alt="" width="75" height="23" class="d-inline-block align-text-top">
                    <h6>4,900 Dealers di seluruh Indonesia</h6>
                </div>
                <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                    <img class="par1-3 me-2" src="./Asset/homeAsset/paralax2.png" alt="" width="75" height="23" class="d-inline-block align-text-top">
                    <h6>100% Gratis</h6>
                </div>
                <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                    <img class="par1-4 me-2" src="./Asset/homeAsset/paralax2.png" alt="" width="75" height="23" class="d-inline-block align-text-top">
                    <h6>Tanpa Ribet Kepengurusan Dokumen</h6>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody>
                        ...
                        <td>
                            <nav class="navbar navbar-dark bg-dark">
                                <div class="container-fluid">
                                    <div class="navbar-toggler" style="border: none;" type="button" data-bs-toggle="collapse" data-bs-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
                                        <span>Hello</span>
                                    </div>
                                </div>
                            </nav>
                    ...
                    <tr>
                        <td>
                            <nav class="navbar navbar-dark bg-dark">
                                <div class="container-fluid">
                                    <div class="navbar-toggler" style="border: none;" type="button" data-bs-toggle="collapse" data-bs-target="#navbarToggleExternalContent2" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
                                        <span>Hello</span>
                                    </div>
                                </div>
                            </nav>
