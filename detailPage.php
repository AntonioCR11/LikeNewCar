...
// ACTIVE CAR
$carID = $_GET["activeCar"];
$car = $cars[$carID - 1];
// CAR DATA
$car_data = $car_datas[$carID - 1];
// echo "<script> alert('car : $carID'); </script>";
...
if (isset($_GET["logout"])) {
    ...
    if (isset($_COOKIE["activeUser"])) {
        ...
        header("Location: detailPage.php?activeCar=$idCar");
    } else {
                    ...
                    <h5 class="card-title">
                        <div class="topItem">
                            ...
                            <div class="topRight ms-auto">
                                <form action="" method="GET">
                                    <button name="like" value="<?= $carID ?>" style="border: none;background-color:rgba(0,0,0,0);">
                                        <img class="likeButton" src="./Asset/shopAsset/shopParalax/likeButton.png" alt="" width="30" height="30" class="d-inline-block align-text-top">
                                    </button>
                                </form>
                            </div>
                        </div>
                        <div class="buttonContainer w-100">
                            ...
                            <form action="">
                                <form action="" method="GET">
                                    <button class="btn btn-primary mt-2 me-auto" style="width: 100%;" name="addToCart" value="<?= $carID ?>">
                                        Add to cart
                                    </button>
                                </form>
                            </form>
